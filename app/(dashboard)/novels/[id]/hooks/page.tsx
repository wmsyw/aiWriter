...
export default function HooksPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 animate-fade-in min-h-screen pb-24">
      ...
      <div className="space-y-2.5 rounded-2xl border border-white/12 bg-[#121926]/88 p-2.5 sticky dashboard-sticky-offset z-20 shadow-xl shadow-black/30 backdrop-blur-md">
            ...
            {STATUS_TABS.map((tab) => (
              <Button
                ...
                className={`h-9 rounded-xl px-4 text-sm font-medium whitespace-nowrap transition-all ${
                  activeTab === tab.id
                    ? 'border border-emerald-400/45 bg-emerald-500/20 text-emerald-50 font-semibold tracking-[0.01em] shadow-[0_0_0_1px_rgba(16,185,129,0.2),0_10px_22px_-14px_rgba(16,185,129,0.85)] hover:bg-emerald-500/26'
      ...
      <div className="rounded-2xl border border-white/12 bg-[#111722]/82 px-3 py-2.5 flex flex-col md:flex-row md:items-center gap-2.5 justify-between">
...
function StatCard({
  ...
  return (
    <div className={`rounded-2xl ${bg} border ${border} px-4 py-3.5`}>
      <div className="flex items-center gap-3">
        <div className={`rounded-lg bg-black/20 p-2 ${color}`}>{icon}</div>
        <div className="min-w-0">
          <div className="text-[11px] font-medium uppercase tracking-wider text-gray-400">{label}</div>
          <div className={`mt-1 text-2xl font-bold leading-none ${color}`}>{value}</div>
        </div>
      </div>
    </div>
  );
...
function HookCard({
  ...
  return (
    <GlassCard
      ...
      padding="md"
      hover={true}
      className="relative group overflow-hidden border-l-4 bg-white/[0.015]"
      style={{
        borderLeftColor:
    ...
    >
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1 space-y-3.5">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-1.5 flex-wrap">
              <label className="mr-1 inline-flex items-center gap-1.5 cursor-pointer select-none">
                <Checkbox
                  checked={selected}
                  ...
                  aria-label="选择钩子"
                />
                <span className="text-[11px] text-zinc-400">选择</span>
              </label>
            ...
            <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
              <Button
                ...
                size="sm"
                onClick={onEdit}
                className="h-8 w-8 rounded-xl border border-white/10 bg-white/[0.03] px-0 text-gray-400 hover:text-emerald-300 hover:bg-emerald-500/12 hover:border-emerald-500/30"
                title="编辑钩子"
                aria-label="编辑钩子"
              >
              ...
              <Button
                ...
                size="sm"
                onClick={onDelete}
                className="h-8 w-8 rounded-xl border border-white/10 bg-white/[0.03] px-0 text-gray-500 hover:text-red-400 hover:bg-red-500/12 hover:border-red-500/30"
                title="删除钩子"
                aria-label="删除钩子"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-2">
            <p className="text-white font-medium text-base leading-7 md:text-lg">{hook.description}</p>
            {hook.notes && <p className="text-zinc-400 text-sm leading-relaxed">{hook.notes}</p>}
            {overdueWarning && (
        ...
        <div className="md:w-56 shrink-0 bg-white/[0.04] rounded-xl p-3.5 border border-white/10 flex flex-col justify-center">
          <div className="relative pl-3.5 border-l-2 border-gray-700/90 space-y-4">
            <div className="relative">
              <div className="absolute -left-[19px] top-1 w-2.5 h-2.5 rounded-full bg-blue-500 border-2 border-[#0f172a]" />
            ...
            {hook.referencedInChapters.length > 0 && (
              <div className="relative">
                <div className="absolute -left-[19px] top-1 w-2.5 h-2.5 rounded-full bg-purple-500 border-2 border-[#0f172a]" />
            ...
            {hook.resolvedInChapter ? (
              <div className="relative">
                <div className="absolute -left-[19px] top-1 w-2.5 h-2.5 rounded-full bg-emerald-500 border-2 border-[#0f172a]" />
              ...
              <div className="relative opacity-60">
                <div className="absolute -left-[19px] top-1 w-2.5 h-2.5 rounded-full bg-gray-700 border-2 border-[#0f172a]" />
      ...
      {isActive && (
        <div className="flex items-center gap-2 pt-3 border-t border-white/10 mt-3">
          <Button
            ...
            size="sm"
            onClick={onReference}
            className="h-9 flex-1 border border-purple-500/25 bg-purple-500/10 text-purple-300 hover:bg-purple-500/20 hover:border-purple-500/35"
          >
            <span>🔗</span>
            记录引用
          </Button>
          <Button
            ...
            size="sm"
            onClick={onResolve}
            className="h-9 flex-1 border border-emerald-500/25 bg-emerald-500/10 text-emerald-300 hover:bg-emerald-500/20 hover:border-emerald-500/35"
          >
            <span>✅</span>
            标记解决
          </Button>
          <Button
            ...
            size="sm"
            onClick={onAbandon}
            className="h-9 flex-1 border border-white/10 bg-white/[0.03] text-gray-300 hover:bg-red-500/10 hover:text-red-300 hover:border-red-500/30"
          >
            <span>🗑️</span>
            放弃钩子
          </Button>
