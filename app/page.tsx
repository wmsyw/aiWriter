...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      <div className="absolute top-20 left-20 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '0s' }} />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-indigo-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      ...
      <main className="relative z-10 container mx-auto px-4 text-center">
        <div className="space-y-8 animate-slide-up">
          <div className="inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-4">
            <span className="text-sm font-medium text-indigo-300">新一代 AI 写作</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="glass-card p-8 rounded-2xl text-left hover:border-indigo-500/30 transition-colors">
          ...
          <div className="glass-card p-8 rounded-2xl text-left hover:border-purple-500/30 transition-colors">
          ...
          <div className="glass-card p-8 rounded-2xl text-left hover:border-pink-500/30 transition-colors">
